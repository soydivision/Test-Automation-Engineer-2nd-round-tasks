...
public class Main {
    public static void main(String[] args) {
        ...
        Faculty astronomyFaculty = new Faculty("Astronomy", Arrays.asList(astroboys101_2020));
        University Stamford = new University("Stamford", Arrays.asList(mathAndPhysicsFaculty, astronomyFaculty));
        ...
        System.out.println("Average mark for " + astronomyFaculty.getName() + " faculty in " + Subjects.CALCULUS_ONE.getName() + " is " + astronomyFaculty.getAverageMarkForSubjectWithinFaculty(Subjects.CALCULUS_ONE));
